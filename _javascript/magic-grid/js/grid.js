...
Grid.prototype.generateTable = function() {
	...
	for(var rowIndex = 0; rowIndex < colAndRowNumber; rowIndex++){
		...
		for(var colIndex = 0; colIndex < colAndRowNumber; colIndex++){
			...
			"<div class='front'><img src='/assets/img/magic-grid/" + content + ".jpg' alt='" + content + "' title='" + title + "' /></div>" +
			"<div class='back'><img src='/assets/img/magic-grid/question.jpg' alt='" + content + "' /></div>" 
		}
	}
	dataTable += "</table>"
	return dataTable
